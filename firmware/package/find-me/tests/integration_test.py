#!/usr/bin/env python3
"""Dependency-free live test for the Linux find-me daemon."""
...
def main():
    binary = os.environ.get("FMD_BINARY", "../src/find-me")
    with tempfile.TemporaryDirectory(prefix="find-me-test-") as directory:
        ...
        with open(log_path, "wb") as log:
            ...
            try:
                ...
                process.terminate()
                process.wait(timeout=5)
        print("find-me live integration tests passed")
